...
try {
    ...
    // Use a standard browser User-Agent to avoid being blocked by WAFs (e.g. Sspai, Jina)
    curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36');
    // Add Accept headers to look more like a browser
    ...
    curl_setopt($ch, CURLOPT_TIMEOUT, 20); // Increased timeout to 20s
    ...
    if ($httpCode >= 200 && $httpCode < 400) {
        ...
        if ($contentType) {
            ...
            // If no content type, try to detect XML
