(function() {
    ...
    function initBackToTop() {
        ...
        const getArticleScrollView = () => document.getElementById('article-scroll-view');

        function onScroll() {
            let scrollTop = window.scrollY || document.documentElement.scrollTop;
            
            // Override for RSS containers if they are active
            const articleScrollView = getArticleScrollView();
            if (articleScrollView && articleScrollView.offsetParent) {
                scrollTop = articleScrollView.scrollTop;
            } else if (articleContent && articleContent.offsetParent) {
        ...
        const scrollToTop = () => {
            ...
            const articleScrollView = getArticleScrollView();
            if (articleScrollView && articleScrollView.offsetParent) {
                articleScrollView.scrollTo({ top: 0, behavior: 'smooth' });
            } else {
